--============================================================
-- PLUGIN: MainStats
-- Shows stat priority with real values
--============================================================
...
--============================================================
-- Stat Value Resolver (Full Names)
--============================================================
...
--============================================================
-- Datapanel Text (Full Stat Name: Value)
--============================================================
...
local function ShowTooltip(self)
    ...
    GameTooltip:AddLine(M:GetColoredPlayerHeader("Main Stats"))
    GameTooltip:AddLine(" ")
...
-- Register plugin
--============================================================
M:RegisterPlugin("mainstats", Plugin)
